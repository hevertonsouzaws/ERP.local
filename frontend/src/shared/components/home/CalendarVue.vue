...
const mudarMes = (delta: number) => {
    // CORREÇÃO: Cria uma nova instância de Data para forçar a reatividade do Vue/Computed.
    ...
    // Tenta selecionar o dia correspondente do novo mês (ex: se era dia 15, vai para o dia 15 do novo mês)
...
<template>
    <div class="w-full bg-gray-800 p-4 rounded-xl shadow-xl text-white">
        <div class="flex justify-between items-center mb-4">
            <button @click="mudarMes(-1)" class="p-2 rounded-full text-gray-400 hover:text-white hover:bg-gray-700 transition">
