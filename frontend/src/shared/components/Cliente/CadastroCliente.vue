...
const clienteNovo = ref<Omit<Cliente, 'id'>>({
    nome: '',
    telefone: ''
});
...
<template>
    <div class="p-6 bg-white shadow-lg rounded-lg max-w-sm mx-auto">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="nome" v-model="clienteNovo.nome" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
        <div class="mb-6">
        ...
        <button @click="salvarCliente" class="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition duration-150">
            Salvar Localmente
        </button>
    </div>
</template>